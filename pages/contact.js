	...
	return (
		<div className=''>
			...
			<main className='overflow-hidden '>
				...
				{/* Contact grid */}
				<section className='w-full bg-zinc' aria-labelledby='offices-heading '>
					<div className='max-w-7xl mx-auto py-24 bg-zinc font-DMSans px-4 sm:py-32 sm:px-6 lg:px-8 '>
						<h2
							id='offices-heading'
